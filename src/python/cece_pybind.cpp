...
PYBIND11_MODULE(_cece_core, m) {
    ...
    py::class_<cece::CeceExportState>(m, "CeceExportState")
        ...
        .def(
            ...
            py::arg("name"), py::arg("array"), "Set a 3D export field from a NumPy float64 array.")
        .def(
            "get_field",
            [](cece::CeceExportState& self, const std::string& name) {
            ...
            py::arg("name"), "Get a 3D field as a NumPy array (zero-copy from Kokkos host view).")
        .def(
            "get_field_names",
            [](const cece::CeceExportState& self) {
                py::list names;
                for (const auto& pair : self.fields) {
                    names.append(pair.first);
                }
    ...
    m.def(
        ...
        []() {
            ...
            switch (logger.GetLogLevel()) {
                case cece::LogLevel::DEBUG:
                    return std::string("DEBUG");
                case cece::LogLevel::INFO:
                    return std::string("INFO");
                case cece::LogLevel::WARNING:
                    return std::string("WARNING");
                case cece::LogLevel::ERROR:
    ...
    m.def(
        "get_default_execution_space_name", []() { return cece::GetDefaultExecutionSpaceName(); },
