/**
 * @file aces_diagnostic_manager.cpp
 * @brief Implementation of the ACES diagnostic field management system.
 *
 * The AcesDiagnosticManager provides centralized management for diagnostic
 * output fields in ACES simulations. It handles field registration, metadata
