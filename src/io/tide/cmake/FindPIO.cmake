...
#
# PIO_<lang>_FOUND   (BOOL) - system has PIO PIO_<lang>_IS_SHARED (BOOL) -
# whether the library is shared/dynamic PIO_<lang>_INCLUDE_DIR (PATH) - Location
# of the header files and modules PIO_<lang>_LIBRARY     (File) - Path to the
# <lang> library files PIO_<lang>_LIBRARIES   (List) - link these to use PIO
#
# Available COMPONENTS are: C Fortran If no components are specified only C is
# assumed
include(LibFind)
include(LibCheck)
