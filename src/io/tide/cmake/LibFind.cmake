...
#
# Input: ${PKG}_DEFAULT             (BOOL) ${PKG}_COMPONENT           (STRING)
# ${PKG}_INCLUDE_NAMES       (LIST) ${PKG}_LIBRARY_NAMES       (LIST)
#
# Returns: ${PKG}_DEFAULT_COMPONENT           (STRING) ${PKG}_VALID_COMPONENTS
# (LIST) ${PKG}_${COMPONENT}_INCLUDE_NAMES  (LIST)
...
#
# Assumes pre-defined variables: ${PKG}_FIND_COMPONENTS        (LIST)
# ${PKG}_DEFAULT_COMPONENT      (STRING) ${PKG}_VALID_COMPONENTS       (LIST)
#
...
#
# Input: INCLUDE_DIRECTORIES LIBRARIES
#
# Ouput: ${PATHLIST}
#
...
#
# Assumes pre-defined variables: ${PKG}_${COMP}_INCLUDE_NAMES or
# ${PKG}_INCLUDE_NAMES ${PKG}_${COMP}_LIBRARY_NAMES or ${PKG}_LIBRARY_NAMES
#
...
function(find_package_component PKG)
  ...
  if(NOT ${PKGCOMP}_FOUND)
    ...
    # Start the search for the include file and library file. Only overload if
      ...
      if(${PKGCOMP}_PREFIX)
        ...
        if(${PKGCOMP}_LIBRARY)
          ...
          if(PREFER_SHARED AND NOT ${PKGCOMP}_IS_SHARED)
            find_shared_library(
              ${PKGCOMP}_SHARED_LIBRARY
              NAMES
              ${${PKGCOMP}_LIBRARY_NAMES}
              PATHS
              ${${PKGCOMP}_PREFIX}
              PATH_SUFFIXES
              lib
