#ifndef ACES_KERNEL_PROFILER_HPP
#define ACES_KERNEL_PROFILER_HPP

/**
 * @file aces_kernel_profiler.hpp
 ...
 * and identify performance bottlenecks in ACES compute kernels.
 */
...
#endif  // ACES_KERNEL_PROFILER_HPP
