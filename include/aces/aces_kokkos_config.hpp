/**
 * @file aces_kokkos_config.hpp
 * @brief Kokkos execution space configuration and runtime utilities for ACES.
 *
 * This header provides utilities for configuring and querying Kokkos execution
 * spaces at runtime. ACES supports multiple execution spaces for performance
 ...
 *
 * - **ACES_DEVICE_ID**: GPU device ID for CUDA or HIP (default: 0)
 *   - Example: `export ACES_DEVICE_ID=1`
 *
 * ## CMake Configuration
 *
 ...
 *
 * All ACES physics kernels use Kokkos::parallel_for and Kokkos::parallel_reduce
...
#ifndef ACES_KOKKOS_CONFIG_HPP
#define ACES_KOKKOS_CONFIG_HPP
 ...
 *
 * Reads ACES_DEVICE_ID environment variable if set, otherwise returns
