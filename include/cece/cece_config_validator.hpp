/**
 * @file cece_config_validator.hpp
 * @brief Configuration validation for CECE
 */
 ...
 * @brief Comprehensive configuration validation for CECE
 */
class ConfigValidator {
   public:
    /**
     * @brief Validate CECE configuration
...
#endif  // CECE_CONFIG_VALIDATOR_HPP
