...
1. **Skip check**: Skip cells with no land fraction or invalid roughness (z0 ≥ 5e-4 m or z0 ≤ 0). Skip cells where soil temperature is below `frozen_soil_threshold` (default 273.15 K).
