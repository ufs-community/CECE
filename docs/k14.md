...
Implements the Kok et al. (2014) dust emission scheme (K14) using Kokkos for GPU-portable parallel execution. This is the most physically detailed dust scheme in CECE, incorporating Shao threshold friction velocity, Zender gravimetric soil moisture, Fécan moisture correction, configurable clay parameterization, MacKinnon drag partition, Laurent erodibility, IGBP vegetation masking, and the Kok (2012, 2014) vertical dust flux formulation.
